...
@Component({
  selector: "app-select-tree-view",
  templateUrl: "./select-tree-view.component.html",
  styleUrls: ["./select-tree-view.component.css"],
  providers: [{ provide: TreeviewI18n, useClass: DropdownTreeviewSelectI18n }]
})
export class SelectTreeViewComponent implements OnChanges {
